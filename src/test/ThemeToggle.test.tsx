...
function renderWithTheme(ui: React.ReactElement, defaultMode: 'light' | 'dark' | 'system' = 'light') {
...
describe('ThemeToggle (expanded)', () => {
  ...
  it('highlights the active mode', () => {
    ...
    expect(screen.getByRole('button', { name: /dark/i })).toHaveClass('bg-accent');
    expect(screen.getByRole('button', { name: /light/i })).not.toHaveClass('bg-accent');
  });
