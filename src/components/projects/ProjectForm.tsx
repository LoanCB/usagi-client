...
export function ProjectForm({ children, project, onDone, open: controlledOpen, onOpenChange: controlledOnOpenChange }: ProjectFormProps) {
            ...
            <div className="flex gap-2 flex-wrap">
              {PRESET_ICONS.map(({ name: iconName, icon: Icon }) => (
                <button
                  ...
                  style={{
                    outline: icon === iconName ? `2px solid ${color}` : undefined,
